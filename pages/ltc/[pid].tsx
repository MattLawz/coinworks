...
export default function ltc() {
    ...
    const valid = cryptaddress("ltc").test(pid);
    ...
    return (
        <>
            ...
            <Center>
                <Stack spacing={5}>
                    <Heading>Donate Litecoin To</Heading>
                    <Code>{pid}</Code>
                    {valid ? null : (
                        <Alert status="error">
                            <AlertIcon />
                    ...
                    <Center>
                        <Link
                            href={
                                "https://blockchair.com/litecoin/address/" + pid
                            }
                        >
                            <a target="_blank" rel="noreferer">
                                ...
                                >
                                    <Image
                                        ...
                                        objectFit="cover"
                                        src={
                                            "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=litecoin:" +
                                            pid
                                        }
                                        alt="QRCode"
                                    />
