...
export default class CreateETH extends React.Component<CreateProps, CreateState> {
    ...
    handleChange(element) {
        if (element.target.value == "") {
            ...
            this.setState({
                output:
                    "https://coinworks.vercel.app/eth/" + element.target.value,
            });
        }
    }
    ...
    render() {
        return (
            ...
            <title>Coinworks</title>
                ...
                <Center>
                    <Stack spacing={8}>
                        <Heading>Ethereum Link Generator</Heading>
                        <Input
