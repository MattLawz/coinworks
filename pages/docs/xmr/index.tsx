...
export default class CreateXMR extends React.Component<CreateProps, CreateState> {
    ...
    handleChange(element) {
        if (element.target.value == "") {
            ...
            this.setState({
                output:
                    "https://coinworks.vercel.app/xmr/" + element.target.value,
            });
        }
    }
    ...
    render() {
        return (
            ...
            <title>Coinworks</title>
                ...
                <Center>
                    <Stack spacing={8}>
                        <Heading>Monero Link Generator</Heading>
                        <Input
