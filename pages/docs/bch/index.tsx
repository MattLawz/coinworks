...
export default class CreateBCH extends React.Component<CreateProps, CreateState> {
    ...
    handleChange(element) {
        if (element.target.value == "") {
            ...
            this.setState({
                output:
                    "https://coinworks.vercel.app/bch/" + element.target.value,
            });
        }
    }
        ...
        return (
            ...
            <title>Coinworks</title>
                ...
                <meta
                    ...
                    content="A website that allows you to make your own custom cryptocurrency donation link! No login or registration needed, comes with many cool features."
                />
                <meta name="og:image" content="/bch.svg" />
                ...
                <Center>
                    <Stack spacing={8}>
                        <Heading>Bitcoin Cash Link Generator</Heading>
                        <Input
